...
MERGE INTO genre (id, genre) VALUES ( 2, 'Драма' );
MERGE INTO genre (id, genre) VALUES ( 3, 'Мультфильм' );
MERGE INTO genre (id, genre) VALUES ( 4, 'Триллер' );
MERGE INTO genre (id, genre) VALUES ( 5, 'Документальный' );
MERGE INTO genre (id, genre) VALUES ( 6, 'Боевик' );
