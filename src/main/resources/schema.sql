...
CREATE TABLE IF NOT EXISTS films_reviews_likes (
                                                   review_like_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                   review_id int REFERENCES films_reviews(review_id),
                                                   user_id int REFERENCES users_model(user_id)
);

CREATE TABLE IF NOT EXISTS films_reviews_dislikes (
                                                      review_dislike_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                      review_id int REFERENCES films_reviews(review_id),
                                                      user_id int REFERENCES users_model(user_id)
);
...
CREATE TABLE IF NOT EXISTS users_feed (
                                          ...
                                          entity_type int REFERENCES entity_types_dictionary(entity_type_id),
                                          entity_id int,
